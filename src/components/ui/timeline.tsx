    ...
    <div className="w-full font-sans" ref={containerRef}>
      ...
      <div ref={ref} className="relative max-w-6xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start shrink-0 md:w-[13rem] lg:w-[15rem]">
              <div className="h-10 absolute left-3 w-10 rounded-full bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-neutral-800 border border-neutral-700 p-2" />
              </div>
              <h3 className="hidden md:block text-xl md:text-4xl lg:text-5xl font-bold text-neutral-500 md:pl-20">
                {item.title}
              </h3>
            </div>

            <div className="relative pl-20 pr-4 md:pl-0 md:pr-2 w-full min-w-0">
