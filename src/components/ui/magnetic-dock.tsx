    ...
    return (
        <motion.button
            ...
            className={cn(
                ...
                "focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 dark:focus-visible:ring-blue-400/50",
                item.isActive && "bg-blue-500/10"
            )}
            style={{
                width: size,
                height: size,
                    ...
                    >
                        ...
                        <div
                            className={cn(
                                ...
                                "w-2 h-2 rotate-45",
                                "bg-slate-950/95",
                                "border-r border-b border-slate-700/60"
                            )}
                        />
                    </motion.div>
                )}
