  ...
  return (
    <div className="bg-slate-900/70 border border-slate-700/60 rounded-2xl p-6 backdrop-blur">
      ...
      <div className="space-y-2">
        ...
        <div className="p-3 rounded-xl bg-gradient-to-r from-purple-500/15 via-slate-800/40 to-slate-800/40 border border-purple-500/20">
          <p className="text-sm text-slate-400">Cumulative GPA</p>
          <p className="text-xl font-bold text-white">{stats.cgpa}</p>
        </div>
      </div>
